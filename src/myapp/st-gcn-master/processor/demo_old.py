...
class Demo(IO):
    ...
    def get_parser(add_help=False):
        ...
        path_final = os.path.dirname(os.path.dirname(__file__))
        path_final2 = os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(__file__)))))
        parser.add_argument('--openpose',
            default=path_final2+'/videos',
            help='Path to openpose')
        parser.add_argument('--output_dir',
            default=path_final+'/data/demo_result',
